...
> [!WARNING]
> Sprintmark 0.8.0 is a single-user application with no authentication. Bind it to `127.0.0.1` or place it behind your own authenticated reverse proxy. Do not expose it directly to the public internet.
